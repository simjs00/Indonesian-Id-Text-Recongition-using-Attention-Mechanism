...
flags.DEFINE_float('noise_1', 0.15, 'Rate at which to set pixels to 0')
flags.DEFINE_float('noise_2', 0.10, 'Rate at which to set pixels to 0')
flags.DEFINE_float('noise_3', 0.10, 'Rate at which to set pixels to 0')
...
flags.DEFINE_float('supervised_learning_rate', 0.1000,
...
flags.DEFINE_string('summary_dir',  "board3",

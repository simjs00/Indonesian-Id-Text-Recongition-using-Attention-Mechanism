...
from recognizer.src.model.model import Model
import  recognizer.src.exp_config as exp_config
sess1 = None
model =None
...
def test(img) :
    ...
    if(sess1==None) :
        print("model")
        main(sys.argv[1:], exp_config.ExpConfig,img)
